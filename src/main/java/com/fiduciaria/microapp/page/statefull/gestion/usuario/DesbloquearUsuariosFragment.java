...
public abstract class DesbloquearUsuariosFragment extends Fragment {
  private final IModel<List<PrincipalPojo>> usuariosModel;
  
  public DesbloquearUsuariosFragment(String id, String markupId, MarkupContainer markupProvider, IModel<List<PrincipalPojo>> model) {
  ...
  protected void onInitialize() {
    ...
    queue(new Component[] { (Component)new IndicatingAjaxLink("confirmar") {
            public void onClick(AjaxRequestTarget target) {
              DesbloquearUsuariosFragment.this.confirmarDesbloquear(target);
            }
          } });
    queue(new Component[] { (Component)new IndicatingAjaxLink("cancelar") {
            public void onClick(AjaxRequestTarget target) {
              DesbloquearUsuariosFragment.this.cancelarDesbloquear(target);
            }
          } });
  }
  
  public abstract void confirmarDesbloquear(AjaxRequestTarget paramAjaxRequestTarget);
  
  public abstract void cancelarDesbloquear(AjaxRequestTarget paramAjaxRequestTarget);
}
