...
public class LetrasPojo implements Serializable {
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof LetrasPojo)) {
         return false;
      } else {
         LetrasPojo other = (LetrasPojo)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof LetrasPojo;
   }
   ...
   public String toString() {
      return "LetrasPojo(codigo=" + this.getCodigo() + ", descripcion=" + this.getDescripcion() + ")";
   }

   public LetrasPojo() {
   }

   public LetrasPojo(String codigo, String descripcion) {
      this.codigo = codigo;
      this.descripcion = descripcion;
   }
}
