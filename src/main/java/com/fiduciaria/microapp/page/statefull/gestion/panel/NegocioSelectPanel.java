package com.fiduciaria.microapp.page.statefull.gestion.panel;

import com.fiduciaria.microapp.base.BasePanel;
import com.fiduciaria.microapp.page.statefull.gestion.actividades.LinkPreIngresoMainPanelUpdBehavior;
...
public class NegocioSelectPanel extends BasePanel {
  private final IModel<List<NegocioPojo>> modeloListaNegocios;
  
  private final IModel<GestionActividadesVM> modeloGestion;
  
  private EnumTipoNegocio tipoNegocio;
  
  public NegocioSelectPanel(String id, IModel<List<NegocioPojo>> model, IModel<GestionActividadesVM> modeloGestion) {
    super(id, model);
      ...
      protected void populateItem(final ListItem<NegocioPojo> item) {
        ...
        item.add(new Behavior[] { (Behavior)new AjaxEventBehavior("click") {
                protected void onEvent(AjaxRequestTarget target) {
                  ((GestionActividadesM)((GestionActividadesVM)NegocioSelectPanel.this.modeloGestion
                    .getObject())
                    .getModelo()
                    .getObject()).getNegocio()
                    .getFideicomiso()
                    .copiarDesde(((NegocioPojo)item.getModelObject()).getFideicomiso());
                  ((GestionActividadesVM)NegocioSelectPanel.this.modeloGestion
                    .getObject()).setSeleccionadoNegocio(true);
                  NegocioSelectPanel.this.registrarComportamiento(LinkPreIngresoMainPanelUpdBehavior.class);
                }
              } });
      }
    }
