...
public class SufijoPojo implements Serializable {
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof SufijoPojo)) {
         return false;
      } else {
         SufijoPojo other = (SufijoPojo)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof SufijoPojo;
   }
   ...
   public String toString() {
      return "SufijoPojo(codigo=" + this.getCodigo() + ", descripcion=" + this.getDescripcion() + ")";
   }

   public SufijoPojo() {
   }

   public SufijoPojo(String codigo, String descripcion) {
      this.codigo = codigo;
      this.descripcion = descripcion;
   }
}
