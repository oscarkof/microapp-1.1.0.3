...
public class CuadrantePojo implements Serializable {
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof CuadrantePojo)) {
         return false;
      } else {
         CuadrantePojo other = (CuadrantePojo)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof CuadrantePojo;
   }
   ...
   public String toString() {
      return "CuadrantePojo(codigo=" + this.getCodigo() + ", descripcion=" + this.getDescripcion() + ")";
   }

   public CuadrantePojo() {
   }

   public CuadrantePojo(String codigo, String descripcion) {
      this.codigo = codigo;
      this.descripcion = descripcion;
   }
}
