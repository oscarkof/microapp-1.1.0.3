...
public class EventoNavegacionAdministracion implements IClusterable {
   private final AjaxRequestTarget request;
   private final EnumOperacionNavegacionPanel payload;

   public EventoNavegacionAdministracion(AjaxRequestTarget request, EnumOperacionNavegacionPanel payload) {
