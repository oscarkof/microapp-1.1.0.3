...
public abstract class BloquearUsuariosFragment extends Fragment {
  private final IModel<List<PrincipalPojo>> usuariosModel;
  
  public BloquearUsuariosFragment(String id, String markupId, MarkupContainer markupProvider, IModel<List<PrincipalPojo>> model) {
  ...
  protected void onInitialize() {
    ...
    queue(new Component[] { (Component)new IndicatingAjaxLink("confirmar") {
            public void onClick(AjaxRequestTarget target) {
              BloquearUsuariosFragment.this.confirmarBloquear(target);
            }
          } });
    queue(new Component[] { (Component)new IndicatingAjaxLink("cancelar") {
            public void onClick(AjaxRequestTarget target) {
              BloquearUsuariosFragment.this.cancelarBloquear(target);
            }
          } });
  }
  
  public abstract void confirmarBloquear(AjaxRequestTarget paramAjaxRequestTarget);
  
  public abstract void cancelarBloquear(AjaxRequestTarget paramAjaxRequestTarget);
}
