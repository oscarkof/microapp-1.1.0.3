...
public class TipoViaPojo implements Serializable {
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof TipoViaPojo)) {
         return false;
      } else {
         TipoViaPojo other = (TipoViaPojo)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof TipoViaPojo;
   }
   ...
   public String toString() {
      return "TipoViaPojo(codigo=" + this.getCodigo() + ", descripcion=" + this.getDescripcion() + ")";
   }

   public TipoViaPojo() {
   }

   public TipoViaPojo(String codigo, String descripcion) {
      this.codigo = codigo;
      this.descripcion = descripcion;
   }
}
